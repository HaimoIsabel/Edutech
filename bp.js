...
// "#b15928"
// "K12":"#a6cee3", "Vocational Edu.":"#1f78b4", "Language Learning":"#b2df8a", "Competence Edu.":"#33a02c", "Early Childhood Edu.":"#fb9a99", "SaaS & Informatization":"#e31a1c", "STEM" :"#fdbf6f", "Study Abroad Services":"#ff7f00", "Higher Edu.":"#b15928", "Paid Knowledge":"#6a3d9a", "Others":"#ffff99"
...
d3.csv("DataSmallMulti.csv", type, function(error, data) {
    ...
    round_keys = ["Seed/Angel", "Pre-A", "A", "B", "C", "D", "E", "Strategic Investment", "Pre-IPO", "Undiscloused"]
	// track sort
